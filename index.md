...
---|---|--- | 
01|Introduction to data management|[Data management](https://github.com/kirenz/bigdata/blob/main/slides/data_management.pdf) 
...
04| SQL and Pandas |  | [Colab](https://colab.research.google.com/github/kirenz/SQL-Introduction/blob/main/8-sql-gapminder/sql-postgres-pandas.ipynb)
04| SQL in VS Code |  | [Colab](https://colab.research.google.com/github/kirenz/SQL-Introduction/blob/main/8-sql-gapminder/sql-postgres-vscode.ipynb)
04| SQL in Jupyter Notebook |  | [Colab](https://colab.research.google.com/github/kirenz/SQL-Introduction/blob/main/8-sql-gapminder/sql-postgres-jupyter.ipynb)
...
Lecture|Topic|Slides | Notebooks 
---|---|--- | ---
01| Network Analysis | [Tutorial](https://github.com/kirenz/python-notebooks/blob/main/network-analysis/social-network-analysis.pdf) |
...
Twitter | Twitter Account | [Doc](https://docs.google.com/document/d/1tUv5Y3vbr_OGx-ahlH1cJFE_j13UKt11WBR27fznBxI/edit?usp=sharing), [Tutorial](https://developer.twitter.com/en/docs/tutorials/step-by-step-guide-to-making-your-first-request-to-the-twitter-api-v2), [tweepy anaconda](https://anaconda.org/conda-forge/tweepy)
